namespace HuaweiARUnitySDK
{
    ...
    {
        private NDKARType arType = NDKARType.COMBINED_AR; //NDKARType.WORLD_AR | NDKARType.HAND_AR;
        ...
        [Obsolete]
        public ARConfigHandFindingMode HandFindingMode = ARConfigHandFindingMode.ENABLE_3D;
        ///endcond
        [Obsolete]
